...
public class RottenTomatoesAgent implements Agent {

    private String apikey;
    private final Logger logger = LoggerFactory
            .getLogger(RottenTomatoesAgent.class);

    public RottenTomatoesAgent(String apikey) {
        this.apikey = apikey;
    }
    ...
    public String requestData(String movieTitle) {
        ...
        try {
            ...
            logger.warn("Failed to connect to Rotten Tomatoes: "
                    + e.getMessage());
            return null;
        }
        ...
        try {
            ...
            logger.warn("Failed to read data from Rotten Tomatoes: "
                    + e.getMessage());
            return null;
        }
